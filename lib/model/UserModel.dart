...
class UserData {
  ...
  UserData.fromJson(jsonRes) {
    ...
    for (var chapter in chapterTops == null ? [] : jsonRes['chapterTops']) {
      chapterTops.add(chapter);
    }

    collectIds = jsonRes['collectIds'] == null ? null : [];
    for (var collect in collectIds == null ? [] : jsonRes['collectIds']) {
      collectIds.add(collect);
    }
  }
