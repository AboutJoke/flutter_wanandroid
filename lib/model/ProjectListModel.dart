...
class ProjectTreeListModel {
  ...
  factory ProjectTreeListModel(jsonStr) => jsonStr == null
      ? null
      : jsonStr is String
          ? new ProjectTreeListModel.fromJson(json.decode(jsonStr))
          : new ProjectTreeListModel.fromJson(jsonStr);
  ...
  ProjectTreeListModel.fromJson(jsonRes) {
    ...
    data = jsonRes['data'] == null
        ? null
        : new ProjectTreeListData.fromJson(jsonRes['data']);
  }
...
class ProjectTreeListData {
  ...
  ProjectTreeListData.fromParams(
      {this.curPage,
      this.offset,
      this.pageCount,
      this.size,
  ...
  ProjectTreeListData.fromJson(jsonRes) {
    ...
    for (var datasItem in datas == null ? [] : jsonRes['datas']) {
      datas.add(datasItem == null
          ? null
          : new ProjectTreeListDatas.fromJson(datasItem));
    }
  }
...
class ProjectTreeListDatas {
  ...
  ProjectTreeListDatas.fromParams(
      {this.chapterId,
      this.courseId,
      this.id,
      this.publishTime,
  ...
  ProjectTreeListDatas.fromJson(jsonRes) {
    ...
    for (var tagsItem in tags == null ? [] : jsonRes['tags']) {
      tags.add(
          tagsItem == null ? null : new ProjectTreeListTag.fromJson(tagsItem));
    }
  }
